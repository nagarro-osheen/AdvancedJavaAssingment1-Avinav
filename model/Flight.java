...
public class Flight implements Constants {
	...
	public String toString() {
		return "FlightNo=" + flightNo + ", Dept=" + depLoc
				+ ", Arr=" + arrLoc 
				+ ", Time=" + flightTime + ", Duration="
				+ String.format("%.2f", flightDuration) + "H, Fare=" + fare + ", seatAvailability="
				+ seatAvailability + ", Class=" + flightClass ;
	}
